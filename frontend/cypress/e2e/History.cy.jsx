describe('Test to see ifSensorHistory component loads', () => {
    ...
    it('QuickFilter Today test', () => {
        ...
        // Hover over different parts of the Recharts surface and capture tooltip texts
